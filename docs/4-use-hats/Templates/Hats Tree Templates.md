Hats Templates are a way to get started using Hats quickly! They are designed to introduce just the right amount of structure, role clarity, and authority delegation for a DAO.
